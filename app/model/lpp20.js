module.exports = app => {
  ...
  let LPP20 = app.model.define('lpp20', {
    contractAddress: {
      type: CHAR(20).BINARY,
      primaryKey: true
    },
  ...
  LPP20.associate = () => {
    ...
    EVMReceiptLog.belongsTo(LPP20, {as: 'lpp20', foreignKey: 'address', sourceKey: 'contractAddress'})
    LPP20.hasMany(EVMReceiptLog, {as: 'logs', foreignKey: 'address', sourceKey: 'contractAddress'})
    Contract.hasOne(LPP20, {as: 'lpp20', foreignKey: 'contractAddress'})
    LPP20.belongsTo(Contract, {as: 'contract', foreignKey: 'contractAddress'})
  }

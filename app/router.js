module.exports = app => {
  ...
  router.get(
    '/address/:address/lpp20-balance/:token',
    addressMiddleware, middleware.contract('token'),
    controller.address.lpp20TokenBalance
  )
  router.get(
    '/address/:address/txs',
  ...
  router.get(
    '/address/:address/lpp20-txs/:token',
    addressMiddleware, middleware.contract('token'), paginationMiddleware,
    controller.address.lpp20TokenTransactions
  )
  router.get(
    '/address/:address/lpp20-mempool-txs/:token',
    addressMiddleware, middleware.contract('token'),
    controller.address.lpp20TokenMempoolTransactions
  )
  router.get(
  ...
  router.get(
    '/address/:address/lpp20-balance-history',
    addressMiddleware, paginationMiddleware,
    controller.address.lpp20BalanceHistory
  )
  router.get(
    '/address/:address/lpp20-balance-history/:token',
    addressMiddleware, middleware.contract('token'), paginationMiddleware,
    controller.address.lpp20BalanceHistory
  )
  ...
  router.get(
    '/contract/:contract/lpp20-balance-history',
    contractMiddleware, paginationMiddleware,
    controller.contract.lpp20BalanceHistory
  )
  router.get(
    '/contract/:contract/lpp20-balance-history/:token',
  ...
  router.get(
    '/lpp20',
    paginationMiddleware,
    controller.lpp20.list
  )
  router.get(
    '/lpp20/txs',
    paginationMiddleware,
    controller.lpp20.allTransactions
  )
  router.get(
    '/lpp20/:token/txs',
    middleware.contract('token'), paginationMiddleware, blockFilterMiddleware,
    controller.lpp20.transactions
  )
  router.get(
    '/lpp20/:token/rich-list',
    middleware.contract('token'), paginationMiddleware,
    controller.lpp20.richList
  )
  router.get(
    '/lpp721',
    paginationMiddleware,
    controller.lpp721.list
  )

...
- [LPP20 API](#LPP20-API)
  - [LPP20 list](#LPP20-list)
  - [LPP20 Transaction list](#LPP20-Transaction-list)


## LPP20 list
List all lpp20 tokens order by transfer transactions count.
...
<table>
    ...
    <tbody>
        <tr>
            <td colspan="3">
              <a href="https://github.com/LightBurdenOfficial/lbchinfo-api/blob/master/README.md#Pagination-Parameters">
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td colspan="3">
              <a href="https://github.com/LightBurdenOfficial/lbchinfo-api/blob/master/README.md#Block--Timestamp-Filter-Parameters">
...
**Request**
```
GET /lpp20/f2033ede578e17fa6231047265010445bca8cf1c/txs?limit=5&offset=0
```
